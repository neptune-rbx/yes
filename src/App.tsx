...
import { Map, User, ListFilter } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans selection:bg-zinc-800 selection:text-zinc-100 pb-24">
      ...
      <header className="sticky top-0 z-40 bg-zinc-950/80 backdrop-blur-xl border-b border-zinc-900 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-zinc-400 hidden sm:block">{tracker.state.profile.name || 'User'}</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        {activeTab === 'profile' && <ProfileTab tracker={tracker} year={year} setYear={setYear} />}
